...
**IGNORE_ERRORS**           | Is used to ignore errors thrown by the adapter. Supported values: `POSTGRESQL_UPPERCASE_TABLES` (see [PostgreSQL dialect documentation][postgresql-dialect-doc]), `TIMESTAMP_WITH_LOCAL_TIME_ZONE_USAGE`(see [Exasol dialect documentation][exasol-dialect-doc]);
