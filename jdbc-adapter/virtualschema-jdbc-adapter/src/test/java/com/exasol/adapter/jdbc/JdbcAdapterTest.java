...
public class JdbcAdapterTest {
    ...
    public void getCredentialsForJDBCImportWithConnectionNameGiven() {
        final SchemaMetadataInfo schemaMetadataInfoConnectionName =
              new SchemaMetadataInfo("", "", this.propertiesConnectionName);
        final String credentials =
              JdbcAdapter.getCredentialsForPushdownQuery(this.exaMetadata, schemaMetadataInfoConnectionName);
    ...
    public void getCredentialsForORAImportWithConnectionNameGiven() {
        ...
        final SchemaMetadataInfo oraSchemaMetadataInfoConnectionName =
              new SchemaMetadataInfo("", "", oraPropertiesConnectionName);
        final String credentials =
              JdbcAdapter.getCredentialsForPushdownQuery(this.exaMetadata, oraSchemaMetadataInfoConnectionName);
    ...
    public void getCredentialsForEXAImportWithConnectionNameGiven() {
        ...
        final SchemaMetadataInfo exaSchemaMetadataInfoConnectionName =
              new SchemaMetadataInfo("", "", exaPropertiesConnectionName);

        final String credentials =
              JdbcAdapter.getCredentialsForPushdownQuery(this.exaMetadata, exaSchemaMetadataInfoConnectionName);
    ...
    public void getCredentialsForJDBCImportWithConnectionStringUsernamePasswordGiven() {
        final SchemaMetadataInfo schemaMetadataInfoConnectionStringUserPassword =
              new SchemaMetadataInfo("", "", this.propertiesConnectionStringUserPassword);
        final String credentials = JdbcAdapter
              .getCredentialsForPushdownQuery(this.exaMetadata, schemaMetadataInfoConnectionStringUserPassword);
    ...
    public void getCredentialsForORAImportWithConnectionStringUsernamePasswordGiven() {
        final Map<String, String> oraPropertiesConnectionStringUserPassword =
              new HashMap<>(this.propertiesConnectionStringUserPassword);
        oraPropertiesConnectionStringUserPassword.put("IMPORT_FROM_ORA", "true");
        final SchemaMetadataInfo oraSchemaMetadataInfoConnectionStringUserPassword =
              new SchemaMetadataInfo("", "", oraPropertiesConnectionStringUserPassword);
        final String credentials = JdbcAdapter
              .getCredentialsForPushdownQuery(this.exaMetadata, oraSchemaMetadataInfoConnectionStringUserPassword);
    ...
    public void getCredentialsForEXAImportWithConnectionStringUsernamePasswordGiven() {
        final Map<String, String> exaPropertiesConnectionStringUserPassword =
              new HashMap<>(this.propertiesConnectionStringUserPassword);
        exaPropertiesConnectionStringUserPassword.put("IMPORT_FROM_EXA", "true");
        final SchemaMetadataInfo exaSchemaMetadataInfoConnectionStringUserPassword =
              new SchemaMetadataInfo("", "", exaPropertiesConnectionStringUserPassword);
        final String credentials = JdbcAdapter
